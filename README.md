...
Run scripts for Windows Portable-apps samples to install and use like explain in [docs](https://github.com/marchandd/term_ssh_wine_antrenamer/docs/summary.md "Summary").
...
:computer: `docker pull marchandd/term_ssh_wine_antrenamer > build.log`

### Command line explanation

All details on [docs](https://github.com/marchandd/term_ssh_wine_antrenamer/docs/summary.md "Summary").

3 methods to find password:

- Search password value into build.log file from marchandd/term_ssh_wine_antrenamer image to access later to container.
...
:computer: `docker run -d -p XXX.XXX.XXX.XXX:YYYYY:22 marchandd/term_ssh_wine_antrenamer`
