...
downloadUrl='http://sourceforge.net/projects/portableapps/files/Ant%20Renamer%20Portable/'
downloadStartPattern='<a href="'$downloadUrl
downloadEndPattern='.paf.exe'
downloadSubstituteModel='s/\/download//'
function defaultValue()
{
  echo $downloadUrl'AntRenamerPortable_2.10.0.paf.exe' > $targetFilePath
}
# Download process
